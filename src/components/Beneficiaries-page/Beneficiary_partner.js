...
import img5 from  '../Assets/Partner icon blue.png'
import img6 from  '../Assets/Profile-img.png'
import img7 from  '../Assets/Partner icon grey.png'
...
const phoneValidation = () =>{
    ...
    let onChange3 = (event) =>{
     ...
     if(newValue =='') {  
     alert("Please input your partner's Date of Birth.") ;
     return false;   
     } 
 ...
 if(age<18){
     ...
     alert("Your partner must be over 18 years.");
    ...
    <div class="container-fluid "  id="c-bg3">
       <div class="container fadeInUp">
        ...
        <div class="container breadcrumb d-flex justify-content-end">
            <p class="d-flex justify-content-start skipButton"><Link to="/Beneficiary"><b>Skip &nbsp; <Icon name="arrow right"/></b></Link><Icon name="arrow"/></p>
        </div>
        <div class="container   fadeInUp">
            <div class="row beneficiaries-row">
                ...
                <div class="col">
                    <div class="card summary-card" id="b-s-card">
                        <span class="text-center s-ry beneficiary-card-heading"><span class="s-ry">Partner</span><img class="img-fluid summary-img" src={img7}/></span>
