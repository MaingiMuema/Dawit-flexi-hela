...
import img6 from  '../Assets/Partner icon grey.png'
  ...
  const fieldConditions = () =>{
    ...
    <div class="container-fluid "  id="c-bg3">
        ...
        <div class="container breadcrumb d-flex justify-content-end">
            <p class="d-flex justify-content-start skipButton"><Link to="/Payment"><b>Skip &nbsp; <Icon name="arrow right"/></b></Link><Icon name="arrow"/></p>
        </div>
        <div class="container   fadeInUp">
            <div class="row beneficiaries-row">
                <div class="col">
                        <p class="Pitch-p">You have made the<br/> right decision.</p>
                        <span>Add a person to benefit <br/>incase an incident occurs</span>
                        <div class="card" id="b-card">
                            <span class="client d-flex"><img class="client-img" src={img5}/>
                             <p>Anne Nonymous</p>
                            </span>
                ...
                <div class="col" id="form2col">
                    <h4 class="form-heading" id="profile-h">Add Beneficiary</h4>
                    <form class="form-2nd" action="./action_handler.php">
                        ...
                        <div class="row">
                            <div class="col">
                                <h3>Date of Birth</h3>
                                    <label class="" for="Target-amount3">
                                        <input class="input-space2" type="date" onInput={onChange3} onChange={onChange3} placeholder="Enter Beneficiary date of birth" id="Target-amount3"/>
                                    </label>
                            </div>
                            <div class="col">
                                <h3>Phone Number</h3>
                            ...
                            <h4 class="add-beneficiary" id=""><a href="/Beneficiary">Add Beneficiary</a></h4>
                        </div>
                    </form>
                ...
                <div class="col">
                    <div class="card summary-card" id="b-s-card">
                        <span class="text-center s-ry beneficiary-card-heading"><span class="s-ry">Partner</span><img class="img-fluid summary-img" src={img6}/></span>
            ...
            <div class="container goal-dets-btns">
                <div class="row n-p-btn">
                    ...
                    <div class="col div-next">
                        <Link to={checkPath} class="btn btn-primary next" onClick={phoneValidation} onMouseUp={fieldConditions }>NEXT</Link>
                    </div>
                </div>
            </div>
        </div>
