...
import img5 from  '../Assets/childrenblue.png'
import img6 from  '../Assets/Profile-img.png'
import img7 from  '../Assets/children grey.png'
...
const Beneficiary_children = () =>{
   ...
   const handleClick4 = () =>{
    ...
    let onChange3 = (event) =>{
     ...
     setInputValue3(newValue);
      ...
      var dob = new Date(newValue); 
        ...
        if(newValue =='') {  
        alert("Please input your Child's Date of Birth.") ;
        return false;   
        } 
    ...
    if(age>18){
        console.log("Age above 18 is:  ", age);
        alert("The child must not exceed 18 years.");
            ...
            <div class="row beneficiaries-row">
                ...
                <div class="col">
                    <div class="card summary-card" id="b-s-card">
                        <span class="text-center s-ry beneficiary-card-heading"><span class="s-ry">Child</span><img class="img-fluid summary-img" src={img7}/></span>
                        ...
                        <hr align="center"class="detail-separator"/>
                        <span class="text-center s-ry" id="set-goals">Phone: <b> {value}</b></span>
                        <hr align="center"class="detail-separator"/>
